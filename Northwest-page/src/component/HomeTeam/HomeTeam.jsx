  ...
  return (
    <div className="p-0 m-0 bg-[#0B6A42]">
      <div className="w-[90%] mx-auto pt-10 pb-6 ">
        <h2 className="text-start lg:text-center font-semibold text-white text-[30px] font-Inter  pb-2">
          Meet <span className="italic text-[20px]">the</span> Team
        </h2>
        <p className="text-start lg:text-center text-white pb-6">
          Get to meet the amazing people responsible for making the magic happen
        </p>
        <p className=" pb-6 text-start lg:text-center text-white font-Urbanist">
        ...
        <div className="flex-col lg: md:flex-row flex justify-center items-center gap-6 flex-wrap pt-4 pb-6">
          {TeamData?.map((item) => (
            <div key={item.id} className="w-[300px]">
              ...
              <p className="text-center text-white text-[12px] lg:text-[16px] italic">{item.title}</p>
            </div>
          ))}
        </div>
      </div>
