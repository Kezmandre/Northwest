  ...
  return (
    <div className="p-0 m-0 bg-slate-200">
      <div className="w-[90%] pt-20 mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center pb-12 gap-8">
          <div className="w-full lg:w-[40%]">
            <h2 className="font-Poppins text-lg font-semibold pb-4 text-[#0B6A42]">
              Northwest Services
            </h2>
            <p className="text-xl lg:text-3xl font-bold font-Poppins">What We Do</p>
          </div>
        ...
        <div className="flex justify-center gap-8 items-center flex-wrap pb-12">
          {ServicesData?.map((item) => {
            return (
              <div
                key={item.id}
                className=" relative w-full lg:w-[260px] h-[300px] bg-white shadow-2xl rounded-md  overflow-hidden group"
              >
